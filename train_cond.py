...
train_dataset, number_of_total_frame_train = md.make_dataset(train_source_path, train_target_path, batch_size, previous_size, frame_size, future_size, shift_size, max_condition, window_type, True)
if early_stopping:
    test_dataset, number_of_total_frame_test = md.make_dataset(test_source_path, test_target_path, batch_size, previous_size, frame_size, future_size, shift_size, max_condition, window_type, True)
